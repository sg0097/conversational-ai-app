...
import { B as Block, S as Static, g as BlockLabel, V as Code$2, i as Empty, k as IconButton, A as Copy$1, D as DownloadLink, n as Download$1, j as IconButtonWrapper, W as getWorkerProxyContext } from './2-BeGfy-dj.js';
...
const lang_map = {
  python: () => import('./index32-CPvuH06C.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index33-DCFF2cx4.js'),
      import('./frontmatter-DoNBUmeG.js')
    ]);
  ...
  json: () => import('./index37-rrbPMsPl.js').then((m) => m.json()),
  html: () => import('./index34-DGPoP0ni.js').then((m) => m.html()),
  css: () => import('./index35-D1VR1FTU.js').then((m) => m.css()),
  javascript: () => import('./index36-BmYz7T-w.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index36-BmYz7T-w.js').then(
...
//# sourceMappingURL=Index15-CYWousuh.js.map
